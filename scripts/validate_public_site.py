...
def main():
    ...
    require(method,("No traduce el español a la lengua ibérica","Dos funciones sonoras, dos modos de recreación","Voz fluida moderna","Síntesis técnica","No es una reconstrucción de cómo hablaban los íberos","iberolab-sign-reading-voice-v2","iberolab-sign-reading-voice-v1","No es un signo ibérico arqueológico","Trazabilidad técnica",'href="./#corpus"','href="privacidad.html"'),"methodology")
