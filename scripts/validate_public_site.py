...
def main():
    ...
    require(index,("Lengua ibérica · Patrimonio · Tecnología","Probar conversor",'id="corpus"','href="historia.html"','href="metodologia.html"','href="academia.html"',"Un monograma-glifo contemporáneo","No es un signo ibérico antiguo","Para la comunidad académica",'href="convertir.html?q=tierra"','dual-28-ti.svg','dual-02-e.svg','dual-34-r2.svg','dual-01-a.svg'),"home")
    require(history,("Comprender el mundo ibérico antes de intentar representarlo","Leer signos no significa traducir el idioma","Una sección preparada para crecer con YouTube","Monedas e inscripciones",'href="./#corpus"','href="academia.html"'),"history")
