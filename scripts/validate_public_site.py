#!/usr/bin/env python3
"""Validate the public identity, history and methodology layer."""
...
def main() -> int:
    files = (INDEX, HISTORY, METHODOLOGY, CONVERTER, STYLE, LOGO)
    ...
    require(history, (
        "Historia y contexto del mundo ibérico",
    ...
    print("PUBLIC SITE VALIDATION OK: home, history, methodology, contemporary emblem and approximate-reading safeguards present.")
    return 0
