...
def main():
    ...
    require(index,("Lengua ibérica · Patrimonio · Tecnología","Probar conversor",'id="corpus"','href="historia.html"','href="metodologia.html"','href="academia.html"',"Un monograma-glifo contemporáneo","No es un signo ibérico antiguo","Para la comunidad académica"),"home")
