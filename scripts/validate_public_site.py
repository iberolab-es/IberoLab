...
def main():
    ...
    require(method,("No traduce el español a la lengua ibérica","Dos funciones sonoras, dos alcances","Recreación experimental","No es una reconstrucción de cómo hablaban los íberos","iberolab-sign-reading-voice-v1","No es un signo ibérico arqueológico","Trazabilidad técnica",'href="./#corpus"','href="privacidad.html"'),"methodology")
    ...
    require(combined_converter,("Escuchar entrada en español","Escuchar aproximación sonora","No reconstruye cómo hablaban los íberos","iberolab-sign-reading-voice-v1",'href="historia.html"','href="metodologia.html"','href="academia.html"','src="iberian-voice.js"','src="converter-ui.js"','data-example="hogar"','data-example="tierra"','data-example="mundo"','data-example="olivo"','data-example="mar"',"cualquier nombre, sentimiento", "palabra o frase breve"),"converter")
    ...
    if "Escuchar en ibero" in combined_converter or "pronunciación auténtica ibérica" in combined_converter: raise ValueError("authentic Iberian pronunciation claim detected")
