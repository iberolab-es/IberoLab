#!/usr/bin/env python3
"""Apply public identity, metadata and academic navigation to existing pages."""
...
META_INDEX = '''  <meta name="description" content="Corpus inicial de formas ibéricas documentadas y representación gráfica normalizada de referencia.">
  <link rel="canonical" href="https://iberolab-es.github.io/IberoLab/">
  <link rel="icon" href="assets/brand/iberolab-mark.svg" type="image/svg+xml">
  <link rel="manifest" href="site.webmanifest">
  <meta name="theme-color" content="#10253a">
  <meta property="og:type" content="website">
  <meta property="og:title" content="IberoLab · Corpus ibérico documentado">
  <meta property="og:description" content="Corpus documentado y demostrador de adaptación fonética experimental mediante signos ibéricos normalizados.">
  <meta property="og:url" content="https://iberolab-es.github.io/IberoLab/">
  <meta property="og:image" content="https://iberolab-es.github.io/IberoLab/assets/brand/iberolab-social-card.svg">
  <meta name="twitter:card" content="summary_large_image">
  <title>IberoLab — Corpus ibérico contrastado</title>'''
replace(
    "docs/index.html",
...
'''
replace("docs/index.html", "    header { margin-bottom: 24px; }", "    header { margin-bottom: 24px; }\n" + TOPBAR_CSS)
replace("docs/convertir.html", "    .topline { display: flex; justify-content: space-between; align-items: center; gap: 16px; }", TOPBAR_CSS + "    .topline { display: flex; justify-content: space-between; align-items: center; gap: 16px; }")
...
'''
replace("docs/index.html", "<main>\n  <header>", "<main>\n" + TOPBAR + "  <header>")
replace("docs/convertir.html", "<main>\n  <header>", "<main>\n" + TOPBAR + "  <header>")

replace(
    "docs/index.html",
    '    ¿Has detectado un error o dispones de una fuente que pueda mejorar el proyecto? <a href="https://github.com/iberolab-es/IberoLab/issues/new/choose" target="_blank" rel="noopener noreferrer">Enviar una sugerencia o aportación</a>.',
    '    ¿Has detectado un error o dispones de una fuente que pueda mejorar el proyecto? <a href="https://github.com/iberolab-es/IberoLab/issues/new/choose" target="_blank" rel="noopener noreferrer">Enviar una sugerencia o aportación</a>.<br><br>\n    <a href="academia.html">Información para universidades y especialistas</a> · <a href="privacidad.html">Privacidad</a>.',
)
replace(
    "docs/convertir.html",
...
# Extend browser regression with the academic page and public metadata.
...
new_tests = '''test.describe('presencia pública y académica', () => {
...
print("Public identity and academic presence applied.")
